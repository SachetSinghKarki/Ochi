  ...
  return (
    <div className=' flex gap-5 w-full h-screen bg-zinc-900 p-20'>
      <div className='w-1/2 h-full flex flex-col justify-between'>
       ...
       <h1 className='text-[7vw] font-bold uppercase leading-none -mb-5'>Eye-</h1>
        <h1 className='text-[7vw] font-bold uppercase leading-none -mb-5'>Opening</h1>
       </div>
      ...
      <div className='w-1/2'>
        <h1 className='text-[6vw] font-bold uppercase  -mb-7 leading-none'>Presentations</h1>
        <div className=' dets mt-10'>
          <a className='block text-xl font-light' href="https://www.instagram.com/sachetsinghkarki/ " target='_blank' >Sachet Singh Karki  </a>
          <a  className='block text-xl font-light' href="https://www.instagram.com/hauvabakery/" target='_blank'>Hauva</a>
          <a  className='block text-xl font-light' href="https://www.facebook.com/sachet.karki.9/" target='_blank'>Facebook Sachet Singh Karki</a>  
        </div>
      </div>
    </div>
  )
